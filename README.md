...
- We encountered an interesting roadblock:
  ...
  - Unfortunately, the issue with this is that it required the user to call a helper function before the loop in their source code
    - This meant the user would have to manually call an additional function before calling function_j()
...
- After implementing these changes and keeping in mind the constraints, the new code had an elapsed time of 257.75 seconds
